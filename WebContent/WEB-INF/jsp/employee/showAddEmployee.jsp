...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath }/employee?method=addEmployee" id="employeeForm" method="post">
		 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    	...
		    	<table>
		    		...
		    		<tr>
		    			...
		    			<td class="font3 fftd">职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;位：
		    			 <select name="jId" id="job_id" style="width:143px;">
			...
			<input type="submit" value="添加">&nbsp;&nbsp;<input type="reset" value="取消 " onclick="cancelClick()"></td></tr>
		  </table>
		 </form>
	</td>
  </tr>
