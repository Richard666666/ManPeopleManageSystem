	...
	$(function(){
		...
		$("a[id^='prev_'").click(function(){
			...
			$.ligerDialog.open({ 
				title:'预览公告',
				height: 500, 
				url: '${pageContext.request.contextPath }/notice?method=previewNotice&nId='+ids.get(), 
				width: 750, 
				showMax: true, 
				showToggle: true, 
				showMin: true, 
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="noticeform" method="post" id="noticeform" action="${pageContext.request.contextPath }/notice?method=selectNotice">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
	  ...
	  <tr valign="top">
	    <td height="20">
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<c:forEach items="${list}" var="notice" varStatus="stat">
				<tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					<td><input type="checkbox" id="box_${stat.index}" value="${notice.nId}"></td>
					 ...
					 <td align="center" width="40px;"><a href="${pageContext.request.contextPath }/notice?method=updateNoticePage&nId=${notice.nId}">
							<img title="修改" src="${pageContext.request.contextPath }/images/update.gif"/></a>
					  </td>
					  <td align="center"  width="40px;"><a href="${pageContext.request.contextPath }/notice?method=previewNotice&nId=${notice.nId}" id="prev_${notice.nId }">
