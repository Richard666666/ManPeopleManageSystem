...
<body style="font-family: 微软雅黑">
	<div class="page-lock">
		...
		<form action="${pageContext.request.contextPath }/users?method=login" method="post" id="loginForm">
		...
		<!-- <input type="hidden" name="method" value="login"> -->
						...
						<div class="controls">
							<div class="input-icon left">
								<i class="icon-lock"></i> <input
									...
									placeholder="密码" id="password" name="uPwd" value="${user.uPwd }">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="page-footer" style="color: #fff">
				兼容浏览器IE8+，最佳分辨率1920*1080. <br>2018 @  Top未来 http://www.xiujie.top
			</div>
		</form>
	</div>
